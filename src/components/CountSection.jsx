...
export default function CountSection() {
  return (
    <div className="w-full h-fit bg-white dark:bg-slate-900 rounded-lg outline-2 dark:outline-slate-700 outline-gray-300 overflow-hidden duration-300 md:px-5 px-3 md:py-5 py-3 grid grid-cols-2 md:grid-cols-4 md:gap-5 gap-3">
      {/* category */}
