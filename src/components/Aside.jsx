...
export default function Aside() {
  return (
    <aside className="h-full md:w-64 w-16 bg-white dark:bg-slate-900 rounded-lg outline-2 dark:outline-slate-700 outline-gray-300 overflow-hidden md:px-5 px-2 py-5 flex flex-col duration-300">
